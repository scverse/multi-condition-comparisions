...
```
cd multi-condition-comparisions
```
...
:::{note}
If you are looking at this document in the [cookiecutter-scverse-instance][] repository documentation, throughout this document the name of the project is `cookiecutter-scverse-instance`. Otherwise it should be replaced by your new project name: `multi-condition-comparisions`.
:::

Now that your new project repository has been created on github at `https://github.com/grst/multi-condition-comparisions` you can push your first commit to github.
To do this, simply follow the instructions on your github repository page or a more verbose walkthrough here:

Assuming you are in `/your/path/to/multi-condition-comparisions`. Add all files and commit.
...
git remote add origin https://github.com/grst/multi-condition-comparisions.git
...
Your project should be now available at `https://github.com/grst/multi-condition-comparisions`. While the repository at this point can be directly used, there are few remaining steps that needs to be done in order to achieve full functionality.
...
The workflows should now succeed and you will be able to find the code coverage at this link: `https://app.codecov.io/gh/grst/multi-condition-comparisions`. You might have to wait couple of minutes and the coverage of this repository should be ~60%.
...
+requires = ["hatchling", "hatch-vcs"]
 ...
 [project]
 name = "multi-condition-comparisions"
-version = "0.3.1dev"
+dynamic = ["version"]
...
+
 [tool.coverage.run]
 source = ["multi-condition-comparisions"]
 omit = [
```
